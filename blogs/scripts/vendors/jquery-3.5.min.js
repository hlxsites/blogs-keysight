...
!(function (e, t) {
  ...
  }; function b(e, t, n) { let r; let i; const o = (n = n || E).createElement('script'); if (o.text = e, t) for (r in c)(i = t[r] || t.getAttribute && t.getAttribute(r)) && o.setAttribute(r, i); n.head.appendChild(o).parentNode.removeChild(o); } function w(e) { return e == null ? `${e}` : typeof e === 'object' || typeof e === 'function' ? n[o.call(e)] || 'object' : typeof e; } const f = '3.5.0'; const S = function (e, t) { return new S.fn.init(e, t); }; function p(e) { const t = !!e && 'length' in e && e.length; const n = w(e); return !m(e) && !x(e) && (n === 'array' || t === 0 || typeof t === 'number' && t > 0 && t - 1 in e); }S.fn = S.prototype = {
